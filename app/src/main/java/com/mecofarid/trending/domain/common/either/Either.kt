package com.mecofarid.trending.domain.common.either
...
/**
 * Map, or transform, the right value [B] of this [Either]
 * into a new [Either] with a right value of type [C].
 * Returns a new [Either] with either the original left value of type [A]
 * or the newly transformed right value of type [C].
 *
